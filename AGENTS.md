...
- `registry/integrations.json` 수정 시 `registry/integrations.schema.json`과
  `INTEGRATIONS.md`의 규칙을 따른다. 등록 PR의 `verified`는 항상 false.
- 이 레포의 공개 문서(README, INTEGRATIONS, 카탈로그 소개)는 친절한 해요체
